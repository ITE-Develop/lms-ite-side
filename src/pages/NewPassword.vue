          ...
          <div class="d-flex h-100">
            <div class="my-auto w-100">
              ...
              <form @submit.prevent="updateProfile" class="my-4">
                <div class="mb-2">
                  <input type="password" v-model="password" class="form-control mb-4" placeholder="New Password" />
                  <input
                    type="password"
                ...
                <button type="submit" class="btn btn-primary w-100 rounded-pill mt-3">Save Password</button>
              </form>
            </div>
          </div>
        </div>
