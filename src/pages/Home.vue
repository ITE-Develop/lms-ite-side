<template>
  ...
  <section class="py-5 bg-light">
    <div class="container py-5">
      <h3 class="fw-bold text-center fs-2 mb-4">Explore Our Popular Courses</h3>
      <PopularCourses />
    </div>
  </section>
  ...
  <section class="py-5">
    <div class="container py-5">
      <h3 class="fw-bold text-center fs-2 mb-5">Top Rated Instructors</h3>
      <FeaturedInstructors />
    </div>
  </section>

  <section class="py-5 bg-light-purple border-top border-bottom">
    <div class="container py-5">
      <h3 class="fw-bold text-center fs-2 mb-5">Hear from Our Students and Instructors</h3>
      <Testimonials />
    </div>
  </section>
