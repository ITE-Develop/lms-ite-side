<template>
  <section v-if="!loadder" class="bg-light vh-100 d-flex align-items-center justify-content-center">
        ...
        <div class="col-6 px-5 py-4">
          ...
          <div class="d-flex h-100">
            <div class="my-auto w-100">
              ...
              <span class="text-muted">Boost your skill always and forever.</span>
              ...
              <form class="my-4" @submit.prevent="registerUser">
                <div class="mb-4">
                  <input
                    type="text"
                    :v-model="name"
                    :class="errors?.name ? 'is-invalid form-control' : 'form-control'"
                    class="form-control"
                ...
                <div class="mb-4">
                  <input
                    type="tel"
                    :v-model="phone"
                    :class="errors?.phone ? 'is-invalid form-control' : 'form-control'"
                ...
                <div class="mb-4">
                  <input
                    type="email"
                    :v-model="email"
                    :class="errors?.email ? 'is-invalid form-control' : 'form-control'"
                    placeholder="Email"
                  />
...
watch(passwordConfirm, (newValue) => {
  errors.value.password_confirmation = newValue ? '' : errors.value.password_confirmation;
});
