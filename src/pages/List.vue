      ...
      <div class="row">
        <div class="col-3">
          <div class="bg-white rounded-3">
            <div class="d-flex justify-content-between align-items-center border-bottom border-light px-3 py-4">
              <h5>Filters</h5>
              <span @click="applyReset" class="text-decoration-none cursor-pointer text-danger">Reset</span>
            </div>
        ...
        <div class="col-9">
          <h1 v-if="search" class="fw-bold text-center mb-5"><span class="text-muted">Search -</span> {{ search }}</h1>
          <h1 v-if="category_id" class="fw-bold text-center mb-5">
            <span class="text-muted">Category -</span>
            {{ categoryTitle }}
          </h1>
          <section class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white mb-4">
            <span>Showing {{ courses.length }} of {{ totalItems }} courses</span>
            ...
            <div class="col-6">
              <form @submit.prevent="performSearch" class="input-group border rounded-pill" role="search">
                <input
                  ...
                  @input="searchInputQuery === '' ? applyReset() : null"
                />
