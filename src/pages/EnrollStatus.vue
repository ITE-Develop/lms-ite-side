      ...
      <section class="bg-light py-5 d-flex justify-content-center align-items-center">
        <section class="container text-center py-5">
          <div v-if="status === 'success'">
            ...
            <p class="my-3 col-lg-7 mx-auto">
              Congratulations! You have successfully enrolled in the course. Begin your learning journey with our
              courses. Watch the video lessons, complete the assignments and take the quizzes to master the skills.
            </p>
            <router-link :to="'/play/' + courseId" class="btn btn-primary mt-3">Go to Course</router-link>
          </div>
