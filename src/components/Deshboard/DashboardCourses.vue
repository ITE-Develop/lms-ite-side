        ...
        <div class="row">
          <div v-for="course in inProgressCourses" :key="course.id" class="col-lg-6 mb-4">
            <div class="theme-shadow rounded d-flex p-3">
              <img :src="course.thumbnail" alt="" height="125px" width="125px" class="object-fit-cover me-3" />
              <div class="w-100">
                <router-link :to="'/instructor/' + course.instructor.id" class="text-decoration-none d-block">{{
                  course.instructor.name
                }}</router-link>
                <router-link :to="'/details/' + course.id" class="text-decoration-none d-block text-hover fs-5 mb-1">{{
                ...
                <div class="d-flex">
                  ...
                  <div class="col-2 my-auto text-end">
                    <span class="text-primary">{{ course.progress ? course.progress : 0 }}%</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div v-for="course in completedCourses" :key="course.id" class="col-lg-6 mb-4">
            <div class="theme-shadow rounded d-flex p-3">
              <img :src="course.thumbnail" alt="" height="125px" width="125px" class="object-fit-cover me-3" />
              <div class="w-100">
                <router-link :to="'/profile/' + course.instructor.id" class="text-decoration-none d-block">{{
                  course.instructor.name
                }}</router-link>
                <router-link :to="'/details/' + course.id" class="text-decoration-none d-block text-hover fs-5 mb-1">{{
                  shortTitle(course.title)
                ...
                <div class="mb-3">
                  <small class="me-3">
                    <i class="bi bi-clock text-success me-1"></i>
                    {{ Math.floor(course.total_duration / 60) }}
                    Hours
                  </small>
                  <small class="me-3">
                    <i class="bi bi-play-circle text-danger me-1"></i>
