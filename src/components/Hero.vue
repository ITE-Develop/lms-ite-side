<template>
  <section class="pb-3 hero">
    ...
    <section class="container">
      <div class="row pb-5">
        <div class="col-lg-6 text-center text-lg-start my-auto mb-5 mb-lg-auto">
          <span class="bg-white px-3 py-2 fw-bold rounded-pill">Hi Learners</span>
          <h3 class="display-4 fw-bold mt-4 mb-5">Discover Your Perfect Learning Path</h3>
          ...
          <div class="col-xl-10">
            <form @submit.prevent="performSearch" class="input-group" role="search">
              ...
              <div class="bg-white search-btn-wrapper">
                <button type="submit" class="btn btn-primary rounded-pill border-3 border-white py-2">
        ...
        <div class="col-lg-6 pt-5 mt-5">
          <div class="position-relative">
            ...
            >
              <div class="d-flex mb-2">
                ...
                <img
                  ...
                  height="30px"
                />
                <span class="student-count bg-white text-dark rounded-circle secondary">8K+</span>
              </div>
              <h3 class="fw-bold">{{ masterStore?.masterData?.total_enrollments }}+</h3>
            ...
            <div
              ...
              :class="{
                'animate-instructor': isInstructorSummaryAnimated,
              }"
            >
              <i class="bi bi-star-fill text-warning fs-3"></i>
              <span
                ><span class="d-block"
                  ><strong>{{ masterStore?.masterData?.total_instructors }}+</strong> Top Rated</span
                >
                Instructors</span
              >
            </div>
            ...
            >
              <h3 class="fw-bold fs-2">{{ masterStore?.masterData?.total_courses }}+</h3>
            ...
            <img
              ...
              :class="{
                'animate-reaction': isReactionIllustrationAnimated,
              }"
            />
            <img
